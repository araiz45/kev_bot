      ...
      3624: function (e, t, n) {
        ...
        function d(e, t) {
          ...
          var r = a(e),
            ...
            c = (0, l.Z)(r),
            u = o
              ? [c].concat(c.visualViewport || [], (0, s.Z)(r) ? r : [])
              : r,
            p = t.concat(u);
                  ...
                  return (
                    (e =
                      "function" == typeof e
                        ...
                        : e),
                    (0, d.Z)("number" != typeof e ? e : (0, c.Z)(e, u.mv))
                  );
                })(p.padding, n),
                w = (0, s.Z)(f),
                y = "y" === g ? u.we : u.t$,
              ...
              if (L) {
                if (m) {
                  var Z,
                    ...
                    ee = (0, o.u)(0, $[F], X[F]),
                    te = O
                      ? $[F] / 2 - q - ee - Q - j.mainAxis
                      : W - ee - Q - j.mainAxis,
                    ne = O
                      ? -$[F] / 2 + q + ee + J + j.mainAxis
                      : Y + ee + J + j.mainAxis,
                ...
                (function (e) {
                  ...
                  return (
                    "rtl" === (0, l.Z)(s || n).direction &&
                      (p +=
                        (0, c.Fp)(n.clientWidth, s ? s.clientWidth : 0) - a),
            ...
            N = (function (e, t, n, i) {
              var s =
                ...
                a = r.reduce(function (t, n) {
                  var s = w(e, n, i);
                  return (
                    (t.top = (0, c.Fp)(s.top, t.top)),
                    (t.right = (0, c.VV)(s.right, t.right)),
                    (t.bottom = (0, c.VV)(s.bottom, t.bottom)),
                    (t.left = (0, c.Fp)(s.left, t.left)),
                    t
                  );
                }, w(e, o, i));
              return (
              ...
              (0, f.kK)(j)
                ? j
                : j.contextElement || (0, r.Z)(e.elements.popper),
              T,
              S,
              d
            ),
          ...
          class h extends a.default {
              ...
              this._queueCallback(
                () => {
                  (this._isTransitioning = !1),
                    ...
                    this._element.classList.add(d, l),
            ...
            hide() {
              ...
              (this._element.style[t] = `${
                ...
                this._element.classList.add(c),
                this._element.classList.remove(d, l);
          ...
          const g = {
            ...
            trigger(t, n, i) {
              ...
              return (
                ...
                l && d.preventDefault(),
                a && t.dispatchEvent(d),
                d.defaultPrevented && r && r.preventDefault(),
                d
              );
            },
          };
          ...
          class P extends p.default {
            constructor(e, t) {
              super(e, t),
                ...
                (this._menu =
                  u.default.next(this._element, x)[0] ||
                  u.default.prev(this._element, x)[0] ||
                  u.default.findOne(x, this._parent)),
            ...
            show() {
              ...
              if (
                !d.default.trigger(this._element, "show.bs.dropdown", e)
                  .defaultPrevented
              ) {
                if (
                  (this._createPopper(),
                  ...
                  for (const e of [].concat(...document.body.children))
                    d.default.on(e, "mouseover", t.noop);
                this._element.focus(),
                  this._element.setAttribute("aria-expanded", !0),
                  this._menu.classList.add(b),
                  this._element.classList.add(b),
                  d.default.trigger(this._element, "shown.bs.dropdown", e);
              }
            }
            hide() {
              if (t.isDisabled(this._element) || !this._isShown()) return;
            ...
            _completeHide(e) {
              if (
                !d.default.trigger(this._element, "hide.bs.dropdown", e)
                  .defaultPrevented
              ) {
                if ("ontouchstart" in document.documentElement)
                  for (const e of [].concat(...document.body.children))
                    d.default.off(e, "mouseover", t.noop);
            ...
            static dataApiKeydownHandler(e) {
              ...
              if (t && !n) return;
              e.preventDefault();
              const s = this.matches(w)
                  ? this
                  : u.default.prev(this, w)[0] ||
                    u.default.next(this, w)[0] ||
                    u.default.findOne(w, e.delegateTarget.parentNode),
          ...
          class E extends p.default {
            ...
            show(e) {
              this._isShown ||
                ...
                d.default.trigger(this._element, v, { relatedTarget: e })
                  .defaultPrevented ||
                ((this._isShown = !0),
                (this._isTransitioning = !0),
            ...
            hide() {
              this._isShown &&
                !this._isTransitioning &&
                (d.default.trigger(this._element, "hide.bs.modal")
                  .defaultPrevented ||
                  ((this._isShown = !1),
                  (this._isTransitioning = !0),
              ...
              this._queueCallback(
                () => {
                  this._config.focus && this._focustrap.activate(),
                    (this._isTransitioning = !1),
                    d.default.trigger(this._element, "shown.bs.modal", {
                      relatedTarget: t,
                    });
                },
                this._dialog,
              ...
              (this._element.style.display = "none"),
                ...
                this._backdrop.hide(() => {
                  document.body.classList.remove(b),
                    ...
                    d.default.trigger(this._element, g);
                });
            }
            _isAnimated() {
            ...
            _triggerBackdropTransition() {
              if (
                d.default.trigger(this._element, "hidePrevented.bs.modal")
                  .defaultPrevented
              )
                return;
              const e =
          ...
          return (
            d.default.on(
              ...
              function (t) {
                ...
                i && E.getInstance(i).hide(),
                  E.getOrCreateInstance(n).toggle(this);
              }
            ),
    ...
    (function () {
      ...
      function M(e) {
        ...
        if (
          ...
          h(d.target).is(i.focusableElements)
        )
      ...
      function K({ swiper: e, extendParams: t, on: n, emit: i }) {
        ...
        function d() {
          ...
          if (
            ("fraction" === n.type &&
              (d.find(X(n.currentClass)).text(n.formatFractionCurrent(c + 1)),
              d.find(X(n.totalClass)).text(n.formatFractionTotal(u))),
            "progressbar" === n.type)
          ) {
            let t;
      ...
      function ke() {
        _e.isTouch ||
          ((_e.isTouch = !0),
          window.performance && document.addEventListener("mousemove", Ae));
      }
      function Ae() {
        var e = performance.now();
        e - Se < 20 &&
          ((_e.isTouch = !1), document.removeEventListener("mousemove", Ae)),
          (Se = e);
      }
      function Oe() {
        var e,
      ...
      function $e(e) {
        var t = (e.plugins || []).reduce(function (t, n) {
          var i,
            ...
            r = n.defaultValue;
          return (
            s && (t[s] = void 0 !== e[s] ? e[s] : null != (i = Me[s]) ? i : r),
            t
          );
        }, {});
      ...
      function je(e) {
        ...
        return (
          !0 === e
            ? (t.className = ae)
            : ((t.className = le), ye(e) ? t.appendChild(e) : De(t, e)),
          t
        );
      }
      function Ne(e, t) {
        ye(t.content)
          ? (De(e, ""), e.appendChild(t.content))
          : "function" != typeof t.content &&
            (t.allowHTML ? De(e, t.content) : (e.textContent = t.content));
      }
      function ze(e) {
        ...
        function s(n, i) {
          ...
          i.theme
            ...
            i.arrow
              ? a
                ? n.arrow !== i.arrow &&
                  (r.removeChild(a), r.appendChild(je(i.arrow)))
                : r.appendChild(je(i.arrow))
              : a && r.removeChild(a);
        }
        return (
          (i.className = oe),
      ...
      function Ge(e, t) {
              ...
              if (!w.state.isDestroyed) {
                ...
                (w.props = i),
                  ...
                  n.interactiveDebounce !== i.interactiveDebounce &&
                    (j(), (g = he(W, i.interactiveDebounce))),
            ...
            show: function () {
              ...
              if (
                ...
                (a = function () {
                  ...
                  (d = A()),
                  (o =
                    (w.props.interactive && l === ce) || "parent" === l
                      ? d.parentNode
                      : fe(l, [d])).contains(x) || o.appendChild(x),
                  (w.state.isMounted = !0),
                  K();
              }
            },
        ...
        function M(e) {
          return (w.state.isMounted && !w.state.isVisible) ||
            ...
            (r && "focus" === r.type)
            ? 0
            : ue(w.props.delay, e ? 0 : 1, Me.delay);
        }
        function L(e) {
          void 0 === e && (e = !1),
        ...
        function V() {
          ...
          e.addEventListener("mousedown", N, !0),
            e.addEventListener("touchend", N, de),
            e.addEventListener("touchstart", Z, de),
            e.addEventListener("touchmove", z, de);
        }
        function B() {
          var e = O();
          e.removeEventListener("mousedown", N, !0),
            e.removeEventListener("touchend", N, de),
            e.removeEventListener("touchstart", Z, de),
            e.removeEventListener("touchmove", z, de);
        }
        function F(e, t) {
          var n = P().box;
          function i(e) {
      ...
      function Re(e, t) {
        ...
        document.addEventListener("touchstart", ke, de),
        ...
        new (class {
          constructor() {
            Ye(
              ...
              Ye(this, "formattedPrice", (e) =>
                new Intl.NumberFormat("default", {
                  style: "currency",
                  currency: "USD",
                }).format(e)
              ),
              Ye(this, "formattedPriceChange", (e) => {
                if (isNaN(e)) return "-";
                ...
                return e > 0
                  ? '<span class="text-green">'.concat(t, "</span>")
                  : e < 0
                  ? '<span class="text-red">'.concat(t, "</span>")
                  : void 0;
              }),
              Ye(this, "renderData", (e) => {
                e.forEach((e, t) => {
                  const n =
                    '<div class="flex crypto-price items-center" data-currency='
                      .concat(
                        e.id,
                      ...
                      .concat(e.priceUsd, '">')
                      .concat(
                        this.formattedPrice(e.priceUsd),
                        '</div>\n        <div class="crypto-price__volume w-1/5 hidden text-right md:block px-3 py-5">'
                      )
                      .concat(
                        this.formattedPrice(e.volumeUsd24Hr),
                        '</div>\n        <div class="crypto-price__change lg:w-[12%] text-right w-[16%] px-3 py-5">'
                      )
                      .concat(
                        this.formattedPriceChange(e.changePercent24Hr),
              ...
              (this.pricesWs = new WebSocket(
                "".concat("wss://ws.coincap.io", "/prices?assets=").concat(Ue)
              )),
              this.fetchData();
          }
          async fetchData() {
            try {
              ...
              const { data: e } = await fetch(
                ""
                  .concat("https://api.coincap.io/v2", "/assets?limit=")
                  .concat(5, "&ids=")
                  .concat(Ue)
              ).then((e) => e.json());
              (this.cryptoPrices.innerHTML = ""),
